...
Version  : 1.1.5
Release  : 10
URL      : http://downloads.xiph.org/releases/opus/opus-1.1.5.tar.gz
Source0  : http://downloads.xiph.org/releases/opus/opus-1.1.5.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1495721834
